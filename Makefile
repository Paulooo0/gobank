...
mock:
	mockgen -package mockdb -destination db/mock/store.go github.com/Paulooo0/gobank/db/sqlc Store

.PHONY: postgres createdb dropdb migrateup migratedown sqlc_init sqlc test server mock